import { APP_EMAIL, APP_WEBSITE } from "@/config";
  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to Grape!, the software program
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Grape!.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Grape!, accessible from{" "}
            <a
              href={APP_WEBSITE}
      ...
      <ul>
        <li>
          By email:{" "}
          <a href={`mailto:${APP_EMAIL}`} target="_blank">
            {APP_EMAIL}
          </a>
        </li>
      </ul>
